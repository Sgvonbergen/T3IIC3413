...
void iic3413dbparserParserInitialize() {
  ...
  auto staticData = std::make_unique<IIC3413DBParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "BETWEEN", "EQ", "NE", "GT", "LT", "GE", "LE", "COMMA", "ASTERISK", 
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	36,38,40,42,44,46,0,4,2,0,8,8,13,13,1,0,18,23,1,0,32,33,1,0,1,17,175,
  	...
  	57,5,3,0,0,57,58,5,14,0,0,58,59,3,42,21,0,59,60,5,30,0,0,60,65,3,10,5,
  	...
  	0,0,70,71,5,6,0,0,71,72,5,7,0,0,72,73,3,42,21,0,73,74,5,15,0,0,74,75,
  	...
  	11,1,0,0,0,96,97,7,0,0,0,97,13,1,0,0,0,98,100,5,12,0,0,99,101,5,4,0,0,
  	...
  	115,5,5,0,0,115,116,3,20,10,0,116,19,1,0,0,0,117,122,3,22,11,0,118,119,
  	...
  	23,1,0,0,0,130,131,5,16,0,0,131,132,3,26,13,0,132,25,1,0,0,0,133,138,
  	...
  	141,145,3,34,17,0,142,145,3,30,15,0,143,145,3,32,16,0,144,141,1,0,0,0,
  	...
  	1,0,0,0,151,152,3,38,19,0,152,153,5,9,0,0,153,154,5,33,0,0,154,33,1,0,
  	0,0,155,156,3,38,19,0,156,157,5,17,0,0,157,158,3,36,18,0,158,159,5,1,
  	0,0,159,160,3,36,18,0,160,35,1,0,0,0,161,164,3,38,19,0,162,164,3,40,20,
  	...
  	23,0,174,172,1,0,0,0,174,173,1,0,0,0,175,43,1,0,0,0,176,177,5,10,0,0,
...
std::vector<IIC3413DBParser::ColumnOrConstantContext *> IIC3413DBParser::BetweenExprContext::columnOrConstant() {
  return getRuleContexts<IIC3413DBParser::ColumnOrConstantContext>();
}

IIC3413DBParser::ColumnOrConstantContext* IIC3413DBParser::BetweenExprContext::columnOrConstant(size_t i) {
  return getRuleContext<IIC3413DBParser::ColumnOrConstantContext>(i);
}
